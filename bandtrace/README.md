...
- Version-tagged source: <https://github.com/harrrshall/alphaspectra-bridgecheck/tree/bandtrace-v0.1.0/bandtrace/source>
...
- `PUBLICATION_VERIFICATION.json` — added after the tag, release assets and Pages bytes are fetched
  back from their public hosts and verified.
